	...
	public View getView(int position, View convertView, ViewGroup parent) {
	    ViewHolder holder;
 		if(convertView == null){
			...
			holder.avatar = (ImageView) convertView.findViewById(cn.ucai.fulicenter.R.id.avatar);
		...
		if(username.equals(Constant.NEW_FRIENDS_USERNAME)){
		    ...
		    holder.avatar.setImageResource(cn.ucai.fulicenter.R.drawable.new_friends_icon);
...
//			    holder.unreadMsgView.setText(user.getUnreadMsgCount()+"");
	...
	public Object[] getSections() {
		...
		list.add(getContext().getString(cn.ucai.fulicenter.R.string.search_header));
